...
na-app-body
  ...
  na-button-group
    ...
    na-button
      span Кнопка 4
  br
  na-checkbox Checkbox 1
  br
  na-checkbox(disabled)
    | Checkbox 2
  br
  na-checkbox Checkbox 3
  br
  na-checkbox Checkbox 4
  br
  br
  na-radio(name="test")
    | Radio 1
  br
  na-radio(name="test" disabled)
    | Radio 2
  br
  na-radio(name="test")
    | Radio 3
  ...
  br
  br
  na-input(label="Label" placeholder="Placeholder" style="width: 270px")
...
import { NaAppBody } from './components/na-app-body'
</script>
